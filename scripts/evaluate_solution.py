...
if __name__ == '__main__':
	...
	if compute_proton == 'yes':
		...
		evaluation.evaluation_photon_plot_BE(saving_df_path, axs[0], axs[1], u_proton_dv, np.array([0, N_proton]), data, Alpha, Beta, Gamma, Delta, max_BE = 200, resolution = 500, max_dose = 45*5.0, dose_resolution = 500)
